...
HD_PWD='C:/Users/daido/Desktop/Polimi/Anno 4/DESD/LAB2/Color2Grey/Color2Grey.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Color2Grey_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Color2Grey_wrapper.tcl
