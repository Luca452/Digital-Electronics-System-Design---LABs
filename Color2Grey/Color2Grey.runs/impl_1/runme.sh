...
HD_PWD='C:/Users/daido/Desktop/Polimi/Anno 4/DESD/LAB2/Color2Grey/Color2Grey.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Color2Grey_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Color2Grey_wrapper.tcl -notrace
