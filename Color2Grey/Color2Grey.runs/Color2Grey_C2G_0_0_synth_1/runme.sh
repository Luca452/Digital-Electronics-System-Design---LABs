...
HD_PWD='C:/Users/daido/Desktop/Polimi/Anno 4/DESD/Git/KittCarPWM/Color2Grey/Color2Grey.runs/Color2Grey_C2G_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Color2Grey_C2G_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Color2Grey_C2G_0_0.tcl
