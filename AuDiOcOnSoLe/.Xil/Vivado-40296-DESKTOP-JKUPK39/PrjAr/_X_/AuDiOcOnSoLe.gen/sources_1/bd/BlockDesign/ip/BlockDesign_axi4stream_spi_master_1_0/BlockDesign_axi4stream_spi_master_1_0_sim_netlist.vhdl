...
-- Date        : Sat May 13 11:58:20 2023
-- Host        : DESKTOP-JKUPK39 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top BlockDesign_axi4stream_spi_master_1_0 -prefix
--               BlockDesign_axi4stream_spi_master_1_0_ BlockDesign_axi4stream_spi_master_1_0_sim_netlist.vhdl
-- Design      : BlockDesign_axi4stream_spi_master_1_0
...
entity BlockDesign_axi4stream_spi_master_1_0_lw_spi_master is
  port (
    cs_o : out STD_LOGIC;
...
end BlockDesign_axi4stream_spi_master_1_0_lw_spi_master;

architecture STRUCTURE of BlockDesign_axi4stream_spi_master_1_0_lw_spi_master is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BlockDesign_axi4stream_spi_master_1_0_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
...
end BlockDesign_axi4stream_spi_master_1_0_axis_lw_spi_master;

architecture STRUCTURE of BlockDesign_axi4stream_spi_master_1_0_axis_lw_spi_master is
...
inst_lw_spi_master: entity work.BlockDesign_axi4stream_spi_master_1_0_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BlockDesign_axi4stream_spi_master_1_0_ipi_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
...
end BlockDesign_axi4stream_spi_master_1_0_ipi_axis_lw_spi_master;

architecture STRUCTURE of BlockDesign_axi4stream_spi_master_1_0_ipi_axis_lw_spi_master is
begin
inst_axis_lw_spi_master: entity work.BlockDesign_axi4stream_spi_master_1_0_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity BlockDesign_axi4stream_spi_master_1_0 is
  port (
    aclk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    s_axis_tvalid : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of BlockDesign_axi4stream_spi_master_1_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of BlockDesign_axi4stream_spi_master_1_0 : entity is "BlockDesign_axi4stream_spi_master_1_0,ipi_axis_lw_spi_master,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of BlockDesign_axi4stream_spi_master_1_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of BlockDesign_axi4stream_spi_master_1_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of BlockDesign_axi4stream_spi_master_1_0 : entity is "ipi_axis_lw_spi_master,Vivado 2020.2";
end BlockDesign_axi4stream_spi_master_1_0;

architecture STRUCTURE of BlockDesign_axi4stream_spi_master_1_0 is
...
U0: entity work.BlockDesign_axi4stream_spi_master_1_0_ipi_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
