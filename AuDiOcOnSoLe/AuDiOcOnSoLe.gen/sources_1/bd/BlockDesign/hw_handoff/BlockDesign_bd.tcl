...
# module references:
# Debouncer, Debouncer, EdgeDetector, EdgeDetector, MovingAverageFilter, digilent_jstk2
...
proc create_root_design { parentCell } {
  ...
  set rx_sdin_1 [ create_bd_port -dir I rx_sdin_1 ]
  ...
  # Create instance: MovingAverageFilter_0, and set properties
  set block_name MovingAverageFilter
  set block_cell_name MovingAverageFilter_0
  if { [catch {set MovingAverageFilter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $MovingAverageFilter_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {100.00} \
  ...
  connect_bd_intf_net -intf_net MovingAverageFilter_0_M_AXIS [get_bd_intf_pins MovingAverageFilter_0/M_AXIS] [get_bd_intf_pins axis_dual_i2s_1/s_axis]
  ...
  connect_bd_intf_net -intf_net axis_dual_i2s_1_m_axis [get_bd_intf_pins MovingAverageFilter_0/S_AXIS] [get_bd_intf_pins axis_dual_i2s_1/m_axis]
  ...
  connect_bd_net -net EdgeDetector_1_output_signal [get_bd_pins EdgeDetector_1/output_signal] [get_bd_pins MovingAverageFilter_0/filter_enable]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins Debouncer_0/clk] [get_bd_pins Debouncer_1/clk] [get_bd_pins EdgeDetector_0/clk] [get_bd_pins EdgeDetector_1/clk] [get_bd_pins MovingAverageFilter_0/aclk] [get_bd_pins axi4stream_spi_master_1/aclk] [get_bd_pins axis_dual_i2s_1/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins digilent_jstk2_0/aclk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_pins MovingAverageFilter_0/aresetn] [get_bd_pins axi4stream_spi_master_1/aresetn] [get_bd_pins axis_dual_i2s_1/aresetn] [get_bd_pins digilent_jstk2_0/aresetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn]
  ...
  connect_bd_net -net rx_sdin_1_1 [get_bd_ports rx_sdin_1] [get_bd_pins axis_dual_i2s_1/rx_sdin]
