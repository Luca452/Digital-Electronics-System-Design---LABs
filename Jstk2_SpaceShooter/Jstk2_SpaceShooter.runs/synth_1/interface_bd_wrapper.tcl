...
synth_design -top interface_bd_wrapper -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef interface_bd_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file interface_bd_wrapper_utilization_synth.rpt -pb interface_bd_wrapper_utilization_synth.pb"
