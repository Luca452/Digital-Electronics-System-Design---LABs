...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lw_spi_master is
  ...
  signal edgecntr : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal \edgecntr[8]_i_1_n_0\ : STD_LOGIC;
  signal \edgecntr[8]_i_3_n_0\ : STD_LOGIC;
  signal \edgecntr[8]_i_4_n_0\ : STD_LOGIC;
  signal \edgecntr[8]_i_5_n_0\ : STD_LOGIC;
  signal \edgecntr[8]_i_6_n_0\ : STD_LOGIC;
  signal edgecntr_0 : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute SOFT_HLUTNM of data_ready_reg_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \edgecntr[0]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \edgecntr[8]_i_4\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \edgecntr[8]_i_5\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of new_data_i_1 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of state_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \write_reg[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \write_reg[1]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \write_reg[2]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \write_reg[3]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \write_reg[4]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \write_reg[5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \write_reg[6]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \write_reg[7]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \write_reg[7]_i_4\ : label is "soft_lutpair14";
...
\edgecntr[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00FEFEFEFE000000"
        ...
        port map (
      I0 => \edgecntr[8]_i_3_n_0\,
      I1 => \edgecntr[8]_i_4_n_0\,
      I2 => edgecntr(4),
      I3 => edgecntr(1),
      I4 => edgecntr(0),
      I5 => edgecntr(2),
...
\edgecntr[8]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => sclk_en,
      O => \edgecntr[8]_i_1_n_0\
    );
\edgecntr[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \edgecntr[8]_i_4_n_0\,
      I2 => edgecntr(4),
      I3 => \edgecntr[8]_i_5_n_0\,
      I4 => \edgecntr[8]_i_6_n_0\,
      I5 => edgecntr(8),
      O => edgecntr_0(8)
    );
\edgecntr[8]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFEF"
    )
        port map (
      ...
      I2 => edgecntr(0),
      I3 => edgecntr(5),
      O => \edgecntr[8]_i_3_n_0\
    );
\edgecntr[8]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
      ...
      I2 => edgecntr(8),
      I3 => edgecntr(7),
      O => \edgecntr[8]_i_4_n_0\
    );
\edgecntr[8]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => edgecntr(6),
      I1 => edgecntr(7),
      O => \edgecntr[8]_i_5_n_0\
    );
\edgecntr[8]_i_6\: unisim.vcomponents.LUT6
    generic map(
