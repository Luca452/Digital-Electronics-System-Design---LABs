...
--Command     : generate_target interface_bd_wrapper.bd
...
entity interface_bd_wrapper is
  port (
...
end interface_bd_wrapper;

architecture STRUCTURE of interface_bd_wrapper is
  component interface_bd is
  port (
    sys_clock : in STD_LOGIC;
    reset : in STD_LOGIC;
    usb_uart_txd : out STD_LOGIC;
...
interface_bd_i: component interface_bd
     port map (
