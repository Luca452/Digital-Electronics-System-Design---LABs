...
################################################################
# This is a generated script based on design: joysticktester
#
...
# source joysticktester_script.tcl
...
set design_name joysticktester
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi4stream_spi_master_0/aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins digilent_jstk2_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi4stream_spi_master_0/aresetn] [get_bd_pins digilent_jstk2_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
