...
entity joysticktester_wrapper is
  port (
...
end joysticktester_wrapper;

architecture STRUCTURE of joysticktester_wrapper is
  component joysticktester is
  port (
    sys_clock : in STD_LOGIC;
    reset : in STD_LOGIC;
...
joysticktester_i: component joysticktester
     port map (
