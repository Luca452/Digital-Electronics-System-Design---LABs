...
-- Command     : write_vhdl -force -mode funcsim -rename_top test_UART_packet_axi4stream_spi_master_0_1 -prefix
--               test_UART_packet_axi4stream_spi_master_0_1_ test_UART_packet_axi4stream_spi_master_0_1_sim_netlist.vhdl
...
entity test_UART_packet_axi4stream_spi_master_0_1_lw_spi_master is
  port (
    cs_o : out STD_LOGIC;
...
end test_UART_packet_axi4stream_spi_master_0_1_lw_spi_master;

architecture STRUCTURE of test_UART_packet_axi4stream_spi_master_0_1_lw_spi_master is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity test_UART_packet_axi4stream_spi_master_0_1_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
...
end test_UART_packet_axi4stream_spi_master_0_1_axis_lw_spi_master;

architecture STRUCTURE of test_UART_packet_axi4stream_spi_master_0_1_axis_lw_spi_master is
...
inst_lw_spi_master: entity work.test_UART_packet_axi4stream_spi_master_0_1_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity test_UART_packet_axi4stream_spi_master_0_1_ipi_axis_lw_spi_master is
  port (
    m_axis_tdata : out STD_LOGIC_VECTOR ( 7 downto 0 );
    sclk_o : out STD_LOGIC;
    cs_o : out STD_LOGIC;
...
end test_UART_packet_axi4stream_spi_master_0_1_ipi_axis_lw_spi_master;

architecture STRUCTURE of test_UART_packet_axi4stream_spi_master_0_1_ipi_axis_lw_spi_master is
begin
inst_axis_lw_spi_master: entity work.test_UART_packet_axi4stream_spi_master_0_1_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
...
entity test_UART_packet_axi4stream_spi_master_0_1 is
  ...
  attribute NotValidForBitStream of test_UART_packet_axi4stream_spi_master_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of test_UART_packet_axi4stream_spi_master_0_1 : entity is "test_UART_packet_axi4stream_spi_master_0_1,ipi_axis_lw_spi_master,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of test_UART_packet_axi4stream_spi_master_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of test_UART_packet_axi4stream_spi_master_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of test_UART_packet_axi4stream_spi_master_0_1 : entity is "ipi_axis_lw_spi_master,Vivado 2020.2";
end test_UART_packet_axi4stream_spi_master_0_1;

architecture STRUCTURE of test_UART_packet_axi4stream_spi_master_0_1 is
...
U0: entity work.test_UART_packet_axi4stream_spi_master_0_1_ipi_axis_lw_spi_master
     port map (
      aclk => aclk,
      aresetn => aresetn,
      cs_o => cs_o,
