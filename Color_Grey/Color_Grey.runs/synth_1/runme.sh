...
HD_PWD='C:/Users/daido/Desktop/Polimi/Anno 4/DESD/LAB2/Color_Grey/Color_Grey.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Color_Grey_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Color_Grey_wrapper.tcl
