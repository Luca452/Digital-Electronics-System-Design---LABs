...
EAStep vivado -log test_UART_packet_jstk_uart_bridge_0_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_UART_packet_jstk_uart_bridge_0_0_1.tcl
