...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_lw_spi_master is
  ...
  attribute SOFT_HLUTNM of \edgecntr[0]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \edgecntr[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \edgecntr[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \edgecntr[3]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \edgecntr[4]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \edgecntr[5]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \edgecntr[7]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \edgecntr[7]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \edgecntr[8]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \edgecntr[9]_i_2\ : label is "soft_lutpair3";
...
\edgecntr[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => edgecntr(6),
      I2 => edgecntr(7),
      I3 => \edgecntr[3]_i_2_n_0\,
      I4 => \edgecntr[5]_i_3_n_0\,
      I5 => edgecntr(3),
      O => edgecntr_0(3)
    );
\edgecntr[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F7"
    )
        port map (
...
\edgecntr[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F0F0F0F0BCACB0A0"
        ...
        port map (
      I0 => \edgecntr[7]_i_2_n_0\,
      I1 => edgecntr(3),
      I2 => edgecntr(5),
      I3 => \edgecntr[5]_i_2_n_0\,
      I4 => edgecntr(4),
      I5 => \edgecntr[5]_i_3_n_0\,
      O => edgecntr_0(5)
    );
\edgecntr[5]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\edgecntr[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\edgecntr[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => edgecntr(4),
      I3 => edgecntr(6),
      I4 => \edgecntr[7]_i_2_n_0\,
      I5 => \edgecntr[7]_i_3_n_0\,
      O => edgecntr_0(6)
    );
...
\edgecntr[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0FF7"
    )
        port map (
...
\edgecntr[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
